...
SECRET_KEY = "django-insecure-tp6l5hyn+8*16i-i7gd$d7vi2fgr^++vf-j87lh=c6^e)yb@a)"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['diegonxscimento.pythonanywhere.com', '127.0.0.1', 'localhost']
...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": "whitenoise.storage.CompressedManifestStaticFilesStorage", # <-- ALTERAR AQUI
    },
}
